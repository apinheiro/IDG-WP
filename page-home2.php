...
<div class="col-md-12 col-sm-12">
		...
		<?php get_template_part('template-parts/busca-acervo2'); ?>

		<?php get_template_part('template-parts/sections-entrada2'); ?>

		
		<?php get_template_part('template-parts/exposicoes2'); ?>

		<?php get_template_part('template-parts/noticias-entrada2'); ?>
