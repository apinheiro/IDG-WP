                    ...
                    <div class="col-1"></div>
                        <div class="col-5 mt-3 p-3 text-uppercase text-center">
                            <div>
                                ...
                                <span class="text-weight-bold text-up-07">Acervo</span>  
                            </div>
                        </div>
                        <div class="col-3 text-center align-items-center">
                            <a href="/institucional" class="br-button secondary mt-2">Institucional</a><br>
                            <em class="text-down-01">A gestão do patrimônio imobiliário da União em publicações da SPU</em>
                        </div>
